...
export default function LogosComponent(props) {
    return (
        <Grid className="LogosComponent" container justify="center" alignItems="center" alignContent="center"
              direction="row" wrap="nowrap">
                <img src="vk-logo.png" alt="Vk logo" width="100px" className="logo"/>
                <svg width="130" height="75" className="logo" viewBox="0 0 130 75" fill="none"
